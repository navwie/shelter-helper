        ...
        <div class="SignPage">
            <div class="d-flex col-12 form-signin container justify-content-center">
                <form action="/createAnimalService" method="post" enctype="multipart/form-data">
                    ...
                    <h1 class="title text-center">Внести дані про тварину</h1>
                   ...
                   <div class="form-group mt-4">
                        <label class="form-group-label" for="sex">Стать</label>
                     ...
                     <div class="form-group mt-4">
                        <label class="form-group-label" for="type">Вид</label>
                        <div class="sex-choice">
                    ...
                    <div class="form-group text-center mt-4">
                        <button class="btn btn-primary" type="submit" :disabled="active">Зареєструвати</button>
                    </div>
                </form>
            </div>
        </div>
